$(function () {
    ...
    var API = {
        timeReg: function (_this) {
            ...
            return {year: _moment.year(), month: _moment.month() + 1, day: _moment.date()}
    ...
    var PICKERTIMEHEADERTPL = '<span class="{{className}}__editor-wrap">' +
        ...
        '<input type="text" autocomplete="off" placeholder="选择日期" name="start-time-day" class="c-datepicker-input__inner c-datePicker__input-day">' +
        '</div>' +
        '</span>' +
        '<span class="{{className}}__editor-wrap">' +
        '<div class="c-datepicker-input c-datepicker-input--small">' +
        '<input type="text" autocomplete="off" placeholder="选择时间" name="start-time-time" class="c-datepicker-input__inner c-datePicker__input-time">' +
        '</div>' +
        '</span>';
    ...
    $.extend(Time.prototype, {
        init: function () {
            ...
            var timerArr = {timer0: '', timer1: '', timer2: ''};
    ...
    $.extend(DatePicker.prototype, {
        init: function () {
            ...
            this.pickerObject.$container.css({top: offset.top + height, left: offset.left});
            $('.c-datepicker-picker').hide();
