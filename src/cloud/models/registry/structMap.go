...
const SelectCloudRegistryServer = "select access,auth_server, name,admin,groups_id,last_modify_time,groups,server_address,cluster_name,create_time,create_user,images_number,username,server_id,last_modify_user,prefix,password,server_domain,description from cloud_registry_server"
