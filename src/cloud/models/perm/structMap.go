...
const SelectPerm5 = `select name, api_type, parent from cloud_api_resource where api_type in  (select name  from cloud_api_resource where api_type in  (select name from cloud_api_resource where api_type  in  (select  distinct parent from cloud_api_resource where parent  in (select api_type  from cloud_api_resource where api_type is not null) )))`
